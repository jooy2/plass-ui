 ...
 * for every segment.
 */
export const PlSegment = React.forwardRef<HTMLElement, PlSegmentProps>(function PlSegment(
 ...
 */
export const PlSegmentedButton = React.forwardRef<HTMLDivElement, PlSegmentedButtonProps>(

...
`labels`는 `Intl`이 아무 의견도 갖지 않는 아흔다섯 개의 항목입니다. "닫기"는 날짜도 숫자도 아니고, 플랫폼의 어느 부분도 그 말을 모릅니다.
...
병합은 키 단위입니다. 네 단어만 정한 프로바이더는 나머지 아흔한 개를 영어로 두고, 다른 프로바이더 안에 들어간 프로바이더는 자기가 이름 붙인 것만 바꾸고 나머지는 물려받습니다.

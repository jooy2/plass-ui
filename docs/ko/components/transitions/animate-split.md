...
- 동작을 줄여 달라고 한 사람에게는 아무것도 움직이지 않습니다. 각 조각은 원래 시작했을 시점까지 그냥 거기 있고, 그 시점부터 마지막 프레임을 보여 줍니다. 그래서 등장은 그대로 있고 <Fw react='mode="out"' flutter="PlassAnimateMode.exit" code />인 줄은 이미 떠나 있습니다.

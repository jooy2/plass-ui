...
<p class="plass-lede">숫자 하나, 그리고 그것에 무슨 일이 일어났는지. 숫자만 있으면 지금 어떤지를 말하고, 옆에 움직임이 있으면 그것이 어디로 가고 있는지를 말합니다.</p>
...
순진한 구현이 틀리는 딱 하나입니다. **움직임의 색은 부호가 아니라 그것이 좋은 소식인지로 정합니다** — 이탈률이 오르는 것은 좋은 소식이 아니고, 거기 붙은 초록 화살표는 누군가에게 거짓말을 하는 대시보드입니다.

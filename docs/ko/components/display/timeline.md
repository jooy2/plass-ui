...
항목의 **인덱스는 prop이 아니고, 될 수도 없습니다**. 목록에서 자기가 몇 번째인지 들어야 하는 항목은 모든 호출자가 틀린 자리에 놓을 수 있는 항목이고, 그러면 `active`는 아무 뜻도 갖지 못합니다. timeline이 자식들을 훑으면서 번호를 매깁니다.
...
둘이 아니라 셋인 이유는 "지금 있는 곳"이 "끝났다"와 같은 주장이 아니기 때문입니다. 어느 단계가 현재인지 말하지 못하는 순서는 그냥 목록입니다.

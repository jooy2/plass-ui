...
**화면은 그 기기의 해상도가 붙은 진짜 viewport입니다.** `md` 휴대폰은 390×844이고, 그다음에 기기 전체가 주어진 자리에 맞춰 한 번 축소됩니다. 그래서 안의 내용은 페이지가 아니라 _화면_ 에 대고 배치됩니다. 390px 열은 휴대폰에서 줄바꿈하는 자리에서 줄바꿈하고, mockup 자체는 페이지에서 200px 폭이어도 내용은 그것을 모릅니다.

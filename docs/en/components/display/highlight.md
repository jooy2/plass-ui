...
| the mark cancels its own padding | it does not | A negative margin is not something Flutter's `Padding` will take. A mark is 4px wider than the word it marks; on a line of running text this is the difference the page owes you. |

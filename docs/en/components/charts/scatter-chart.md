...
`varied` turns the shapes on regardless, which is what to use when the chart will be printed or read in greyscale. Naming one of the five shapes puts every mark in it, and on four or more series that is opting out of the second channel.

...
| A chevron that points along the reading direction, a breadcrumb's, a pagination stepper's, a submenu's, a navigation rail's, a `PlTree`'s closed twisty, a `PlTransfer` arrow | **Flip.** One glyph, turned |

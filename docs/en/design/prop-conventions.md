...
The one place the same word means two things is `solid` on something typed into: there it is the **well**, not a moulded key. See [TextField](../components/inputs/text-field#variant).

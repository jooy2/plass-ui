...
- A change to a component usually touches its page in both `docs/en` and `docs/ko`, and the props table in `docs/.vitepress/data/`. A component that exists in both packages should say the same things on one page.
